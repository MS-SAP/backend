...
describe("The screening invitation mails", function () {
    beforeEach(function () {
        ...
        this.sendTemplateMailStub = sinon
            .stub(mailHandler, "sendTemplateMail")
            .returns(
                new Promise((resolve) => {
                    resolve();
                })
    ...
    describe("The method sendFirstScreeningInvitationMail", function () {
        it("Prepares the mail data", function () {
            // Act
            return screening
                .sendFirstScreeningInvitationMail(this.TestStudent)
                .then(
                    function () {
                        // Assert
                        assert.ok(
                            this.sendTemplateMailStub.calledWith(
                                {
                                    ...
                                    variables: {
                                        personFirstname: this.TestStudent
                                            .firstname,
    ...
    describe("The method sendScreeningInvitationReminderMail", function () {
        it("Prepares the mail data", function () {
            // Act
            return screening
                .sendScreeningInvitationReminderMail(this.TestStudent)
                .then(
                    function () {
                        // Assert
                        assert.ok(
                            this.sendTemplateMailStub.calledWith(
                                {
                                    title:
                                        "Erinnerung: Wir möchten dich kennenlernen!",
                                    sender: DEFAULTSENDERS.screening,
                                    id: 1391548,
    ...
    describe("The method sendFirstInstructorScreeningInvitationMail", function () {
        it("Prepares the mail data", function () {
            // Act
            return screening
                .sendFirstInstructorScreeningInvitationMail(this.TestStudent)
                .then(
                    function () {
                        // Assert
                        assert.ok(
                            this.sendTemplateMailStub.calledWith(
                                {
                                    ...
                                    variables: {
                                        instructorFirstName: this.TestStudent
                                            .firstname,
